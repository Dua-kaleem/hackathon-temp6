...
const ContactForm = () => {
  ...
  return (
    <div className="container mx-auto p-8 lg:px-[260px]">
         <div className="flex flex-col items-center justify-center max-w-[644px] gap-0.5 sm:gap-2 lg:mb-16">
        <p className="text-2xl sm:text-4xl font-semibold text-center py-4 px-8 ">
          Get In Touch With Us
        </p>
        <p className="text-sm sm:text-base text-[#9F9F9F] text-center py-8 px-">
